...
import { EsAdminGuard, EstaLogueadoGuard } from './es-admin.guard';
...
import { IndiceSalasComponent } from './salas/indice-salas/indice-salas.component';
import { IndiceUsuariosComponent } from './seguridad/indice-usuarios/indice-usuarios.component';
import { LoginComponent } from './seguridad/login/login.component';
import { RegistroComponent } from './seguridad/registro/registro.component';
import { CrearSnackComponent } from './snacks/crear-snack/crear-snack.component';
import { IndiceSnackComponent } from './snacks/indice-snack/indice-snack.component';
...
const routes: Routes = [
  ...
  {path: 'peliculas/buscar', component: FiltroPeliculasComponent, canActivate: [EstaLogueadoGuard]},
  ...
  {path: 'snacks',component:IndiceSnackComponent, canActivate: [EstaLogueadoGuard]},
  {path:'salas',component:IndiceSalasComponent,canActivate:[EsAdminGuard]},
  {path: 'salas/crear', component: CrearSalaComponent, canActivate: [EsAdminGuard]},
  {path:'snack',component:IndiceSnackComponent,canActivate:[EsAdminGuard]},
  {path: 'snack/crear', component: CrearSnackComponent, canActivate: [EsAdminGuard]},
  {path: '**', redirectTo: ''}
];
